                        ...
                        <table class="table table-striped table-hover table-bordered">
                            ...
                            <tbody>
                                @foreach ($reservasis as $reservasi)
                                    ...
                                    <td><strong>{{ \Carbon\Carbon::parse($reservasi->tanggal_reservasi)->format('d M Y H:i') }}</strong>
                                    </td>
                                    <td><strong>{{ $reservasi->jumlah_orang }}</strong></td>
                                    <td>
                                        <span
                                            class="badge {{ $reservasi->status == 'confirmed' ? 'badge-success' : ($reservasi->status == 'pending' ? 'badge-warning' : 'badge-danger') }}">
